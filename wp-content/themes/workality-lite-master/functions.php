...
if ( ! function_exists( 'showSharing' ) ) {
	function showSharing() {
		...
		$youtube = of_get_option('md_social_youtube');
		$github = of_get_option('md_social_github');
		...
		if($youtube) {
			$args = array_merge($args,array('youtube'=>$youtube));
		}

		if($github) {
			$args = array_merge($args,array('github'=>$github));
		}
